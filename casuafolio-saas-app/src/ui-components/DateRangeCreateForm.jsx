...
import { createDateRange } from "../graphql/mutations";
const client = generateClient();
export default function DateRangeCreateForm(props) {
  const {
    clearOnSuccess = true,
    onSuccess,
    onError,
  ...
  return (
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await client.graphql({
            query: createDateRange.replaceAll("__typename", ""),
            variables: {
              input: {
                ...modelFields,
              },
      ...
      {...getOverrideProps(overrides, "DateRangeCreateForm")}
      {...rest}
    >
      <TextField
        label="Start"
