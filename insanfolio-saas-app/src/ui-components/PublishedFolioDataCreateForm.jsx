...
import { createPublishedFolioData } from "../graphql/mutations";
const client = generateClient();
export default function PublishedFolioDataCreateForm(props) {
  const {
    clearOnSuccess = true,
    onSuccess,
    onError,
  ...
  return (
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await client.graphql({
            query: createPublishedFolioData.replaceAll("__typename", ""),
            variables: {
              input: {
                ...modelFields,
              },
      ...
      {...getOverrideProps(overrides, "PublishedFolioDataCreateForm")}
      {...rest}
    >
      <TextAreaField
        label="Custom data"
