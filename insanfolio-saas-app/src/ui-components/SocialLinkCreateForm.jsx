...
import { createSocialLink } from "../graphql/mutations";
const client = generateClient();
export default function SocialLinkCreateForm(props) {
  const {
    clearOnSuccess = true,
    onSuccess,
    onError,
  ...
  const resetStateValues = () => {
    setSocialPlatformType(initialValues.SocialPlatformType);
    setUrlPostfix(initialValues.urlPostfix);
    setErrors({});
  };
  const validations = {
  ...
  return (
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await client.graphql({
            query: createSocialLink.replaceAll("__typename", ""),
            variables: {
              input: {
                ...modelFields,
              },
      ...
      {...getOverrideProps(overrides, "SocialLinkCreateForm")}
      {...rest}
    >
      <SelectField
